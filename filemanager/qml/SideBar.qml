...
ListView {
    ...
    leftMargin: CuteUI.Units.smallSpacing * 1.5
    rightMargin: CuteUI.Units.smallSpacing * 1.5
    ...
    highlight: Rectangle {
        ...
        Rectangle {
            ...
            color: Qt.rgba(CuteUI.Theme.highlightColor.r,
                           ...
                           CuteUI.Theme.highlightColor.b, CuteUI.Theme.darkMode ? 0.3 : 0.2)
        }
    }
    ...
    delegate: Item {
        id: _item
        width: ListView.view.width - ListView.view.leftMargin - ListView.view.rightMargin
        height: CuteUI.Units.fontMetrics.height + CuteUI.Units.largeSpacing * 1.5

        property bool checked: sideBar.currentIndex === index
        property color hoveredColor: CuteUI.Theme.darkMode ? Qt.lighter(CuteUI.Theme.backgroundColor, 1.1)
        ...
        Rectangle {
            anchors.fill: parent
            radius: CuteUI.Theme.mediumRadius
            color: _mouseArea.pressed ? Qt.rgba(CuteUI.Theme.textColor.r,
                                               CuteUI.Theme.textColor.g,
                                               CuteUI.Theme.textColor.b, CuteUI.Theme.darkMode ? 0.05 : 0.1) :
                   _mouseArea.containsMouse && !checked ? Qt.rgba(CuteUI.Theme.textColor.r,
                                                                  CuteUI.Theme.textColor.g,
...
//                source: "qrc:/images/" + (CuteUI.Theme.darkMode || checked ? "dark/" : "light/") + model.iconPath
                ...
                layer.effect: ColorOverlay {
                    color: checked ? CuteUI.Theme.highlightColor : CuteUI.Theme.textColor
                }
            }
