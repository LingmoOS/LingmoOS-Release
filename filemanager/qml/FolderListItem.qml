...
Item {
    ...
    property color hoveredColor: CuteUI.Theme.darkMode ? Qt.lighter(CuteUI.Theme.backgroundColor, 2.3)
                                                       : Qt.darker(CuteUI.Theme.backgroundColor, 1.05)
    property color selectedColor: CuteUI.Theme.darkMode ? Qt.lighter(CuteUI.Theme.backgroundColor, 1.2)
                                                        : Qt.darker(CuteUI.Theme.backgroundColor, 1.15)
//    onSelectedChanged: {
//        if (selected && !blank) {
...
//    }
    ...
    Rectangle {
        ...
        color: selected ? CuteUI.Theme.highlightColor : hovered ? hoveredColor : "transparent"
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            Label {
                id: _label2
                text: model.fileSize
                color: selected ? CuteUI.Theme.highlightColor : CuteUI.Theme.disabledTextColor
                textFormat: Text.PlainText
                Layout.fillWidth: true
                opacity: model.isHidden ? 0.8 : 1.0
            }
