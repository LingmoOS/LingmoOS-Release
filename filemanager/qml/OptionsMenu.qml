...
CuteUI.DesktopMenu {
    ...
    MenuItem {
        ...
        Image {
            ...
            source: CuteUI.Theme.darkMode ? "qrc:/images/dark/grid.svg" : "qrc:/images/light/grid.svg"
        ...
        Image {
            ...
            source: CuteUI.Theme.darkMode ? "qrc:/images/dark/checked.svg" : "qrc:/images/light/checked.svg"
            sourceSize: Qt.size(width, height)
            width: 22
            height: width
    ...
    MenuItem {
        ...
        Image {
            ...
            anchors.left: parent.left
            anchors.leftMargin: CuteUI.Units.largeSpacing
            source: CuteUI.Theme.darkMode ? "qrc:/images/dark/list.svg" : "qrc:/images/light/list.svg"
            sourceSize: Qt.size(width, height)
            width: 22
            height: width
            smooth: false
...
//            anchors.left: parent.left
//            anchors.leftMargin: CuteUI.Units.largeSpacing
//            source: CuteUI.Theme.darkMode ? "qrc:/images/dark/order_by_name.svg" : "qrc:/images/light/order_by_name.svg"
//            sourceSize: Qt.size(width, height)
//            width: 22
//            height: width
//            smooth: false
...
//            anchors.left: parent.left
//            anchors.leftMargin: CuteUI.Units.largeSpacing
//            source: CuteUI.Theme.darkMode ? "qrc:/images/dark/date.svg" : "qrc:/images/light/date.svg"
//            sourceSize: Qt.size(width, height)
//            width: 22
//            height: width
//            smooth: false
...
//            anchors.left: parent.left
//            anchors.leftMargin: CuteUI.Units.largeSpacing
//            source: CuteUI.Theme.darkMode ? "qrc:/images/dark/size.svg" : "qrc:/images/light/size.svg"
//            sourceSize: Qt.size(width, height)
//            width: 22
//            height: width
//            smooth: false
