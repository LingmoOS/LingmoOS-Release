...
var allowlist = [
    "cute-launcher cute-launcher",
    "cute-screenshot cute-screenshot"
];
...
var cutePopupsEffect = {
    loadConfig: function () {
        cutePopupsEffect.fadeInDuration = animationTime(100);
        cutePopupsEffect.fadeOutDuration = animationTime(100) * 4;
    },
    slotWindowAdded: function (window) {
        ...
        window.fadeInAnimation = animate({
            ...
            duration: cutePopupsEffect.fadeInDuration,
            type: Effect.Opacity,
            from: 0.0,
            to: 1.0
        });
    ...
    slotWindowClosed: function (window) {
        ...
        window.fadeOutAnimation = animate({
            ...
            duration: cutePopupsEffect.fadeOutDuration,
            type: Effect.Opacity,
            from: 1.0,
            to: 0.0
        });
    ...
    init: function () {
        cutePopupsEffect.loadConfig();

        effect.configChanged.connect(cutePopupsEffect.loadConfig);
        effects.windowAdded.connect(cutePopupsEffect.slotWindowAdded);
        effects.windowClosed.connect(cutePopupsEffect.slotWindowClosed);
        effects.windowDataChanged.connect(cutePopupsEffect.slotWindowDataChanged);
    }
};

cutePopupsEffect.init();
